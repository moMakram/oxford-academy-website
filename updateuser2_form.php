...
<title>اضافه صلاحيه المدرس</title>
...
$username = $_POST['username'];
	...
	$result = mysql_query("select * from prev where username='$username' and type='teacher'");
...
?>
    ...
    <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php  echo $row['password']; ?></td>
	  ...
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="update_user2.php?id='); echo $row['id']; ?>"> <font color="white"> update </font></a> </td>
    </tr> 
	<?php
