...
<input name="submit" id="submit4" type="submit" value="حفظ التعديلات" />
  ...
  <?php
	...
	$result2 = mysql_query(" update prev set  username='$_POST[username]',password='$_POST[password]' where id='$_POST[id]' " );
...
echo " <font size='3px' >اذا لم يتم نقلك تلقائيا  </font> <a href='updateusers_form.php'><font size='4px'> اضغط هنا </font> </a> </font>"; 
echo "<meta http-equiv=\"refresh\" content=\"1;URL=updateusers_form.php\">";
