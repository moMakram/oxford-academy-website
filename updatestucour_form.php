...
////$result = mysql_query("select * from stucourse");
...
<title>التعديل على كورسات الطلبه</title>
...
<br><br>
  ...
  <table width="980" height="100" border="0">
	...
	<?php
	$result = mysql_query("select * from stucourse where id2='$id3'");
...
?>
    ...
    <tr style="text-align:center;">
      ...
      <td style="width:160px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php  echo $row['section']; ?></td>
      <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php  echo $row['day']; ?></td>

	    
  
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="delete2.php?id3= '); echo $row['id']; echo('&id='); echo $id;   echo('&table=stucourse'); echo('&form=updatestucour1_form'); ?>"> <font color="white"> delete </font></a> </td>
    </tr> 
	<?php
