...
<div id="body2">
<center>
<font size="7" > اخر الاخبار </font></center>
<center>
<br/><br/>
<form method="POST" >

<font size="5" > الخبر بالعربية </font>
<input type="text" name="descr" id="descr" size="79" dir="rtl" />

<br/><br/><br/>
<font size="5" > الخبر بالانجليزية </font>
...
$result=mysql_query("insert into marque (descr,descr2,id2) values ('$descr','$descr2','$order')");
