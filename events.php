...
<a href="Gallery.php?name='); echo $rows['title2']; echo('"><div id="pictures"></div></a>
<div id="Grafic">
<div id="Graficwords"><font color="#FFFFFF" face="Comic Sans MS, cursive" size="4" ><center><b>'); echo $rows['title2']; echo('</b></center></font></div>
</div>
...
<div id="courses2">'); echo $rowse['descr2']; echo('</div>
<br /><br />
');
}
echo('
