...
$(document).ready(function(e) {
  	...
  	if($up){
			alert('تم ارسال السؤال ..... انتظر الرد قريبا جدا');
...
$(document).ready(function(h) {
			...
			alert('لم يتم ارسال السؤال .... من فضلك حاول مرة اخرى');
...
<a href="services2.php"><div id="services2"></div></a>
...
<input name="name" type="text" id="textfiled16" value="   أدخل إسمك هنا......"  placeholder="   أدخل إسمك هنا......" onfocus="this.value=('   ');"/>

<textarea name="question" cols="" rows="" wrap="virtual" id="textarea2" value=" أدخل سؤالك هنا......"   placeholder=" أدخل سؤالك هنا......" onfocus="this.value=(' ');"></textarea>

<input type="submit" id="sub2" name="submit" 
  value="send"  />
</form>
<div id="Answers">
