...
$result = mysql_query("select * from album where id ='$id3'");
...
<font size="8" > التعديل على صور الاحداث </font>
<br/><br/>
...
if($_FILES["file"]["error"] > 0)
{
	$result2 = mysql_query(" update album set id2='$_POST[id2]'  where id='$_POST[id]'  " ) ;
...
echo " <font size='3px' >اذا لم يتم نقلك تلقائيا  </font> <a href='updatealbum_form.php?id="; echo $id; echo"'><font size='4px'> اضغط هنا </font> </a> </font>"; 
echo "<meta http-equiv=\"refresh\" content=\"2;URL=updatealbum_form.php?id="; echo $id; echo"\">";
...
echo("error");
	...
	$result2 = mysql_query(" update album set link='$dir',id2='$_POST[id2]' where id='$_POST[id]' " );
