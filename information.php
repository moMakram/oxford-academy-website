...
<div style=" width:900px; height:500px; position:relative; margin-top:57px; margin-left:160px;">

');

$select = mysql_query("select * from proditem where id='$idpro' ");
$row = mysql_fetch_array($select);

echo('

<div id="info_name">
<div id="info_name2"><center><b>'); echo $row['name']; echo('</b></center></div>
</div>
<div id="info_price">
<div id="info_price2"><center>'); echo('<a href="'.$row['down'].'" >'.' ');
			  
			   echo(' <font color="#000000" ><b>تحميل </b></font> </a></center></div>
</div>
<div id="info_qualities">  </div>
<div id="qualities"><div id="qualities2"><center><br/><b>'); echo $row['descr']; echo('</b></center></div></div>
