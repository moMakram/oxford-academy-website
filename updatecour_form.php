...
<title>التعديل على الكورسات</title>
...
echo ("<h2><center> عدد الكورسات  => $count  </h2></center>"); 
...
?>
    ...
    <tr style="text-align:center;">
      ...
      <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="update_cour.php?id3= '); echo $row['id']; echo('&id=');echo $id; ?>"> <font color="white"> update </font></a> </td>
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="delete_cour.php?id3= '); echo $row['id']; echo('&id=');echo $id; echo('&table=marque'); echo('&form=updatenews_form'); ?>"> <font color="white"> delete </font></a> </td>
    </tr> 
	<?php
