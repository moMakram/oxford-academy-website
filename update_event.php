...
$result = mysql_query("select * from event where id ='$id3'");
...
<br/><br/>
  ...
  <?php
	...
	$result2 = mysql_query(" update event set title='$_POST[title]',title2='$_POST[title2]', descr='$_POST[descr]',id2='$_POST[id2]',descr2='$_POST[descr2]' where id='$_POST[id]'  " ) ;
...
echo " <font size='3px' >اذا لم يتم نقلك تلقائيا  </font> <a href='updateevent_form.php?id="; echo $id; echo"'><font size='4px'> اضغط هنا </font> </a> </font>"; 
echo "<meta http-equiv=\"refresh\" content=\"4;URL=updateevent_form.php?id="; echo $id; echo"\">";
