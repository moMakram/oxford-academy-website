...
echo ("<h2><center>عدد المواضيغ  => $count  </h2></center>"); 
 ...
 ?>
  ...
  <table width="980" height="100" border="0">
    <tr style="background:#999; height:35px;">
	  ...
	  <td style="width:90px; height:46px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#000; text-align:center;">صوره الموضوع</td>
...
<td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php  echo $row['descr2']; ?></td>
     <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo('<img src="'.$row['link'].'" width="100px" height="100px"/> '); ?></td>
      ...
      <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="update_topics.php?id3= '); echo $row['id']; echo('&id=');echo $id; ?>"> <font color="white"> update </font></a> </td>
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="delete.php?id3= '); echo $row['id']; echo('&id=');echo $id; echo('&table=topics'); echo('&form=updatetopic_form'); ?>"> <font color="white"> delete </font></a> </td>
    </tr> 
	<?php
