...
<div id="body2">
<br/><br/>
<center><font size="6"> رفع الصور المتحركه من هنا </font></center>
...
<form method="POST">
<br/><br/><br/>
<font size="5">&nbsp; وصف الصورة بالعربية </font>
<input type="text" size="90" name="descr" />

<br/><br/><br/>
<font size="5">&nbsp; وصف الصوره بالانجليزية </font>
<input type="text" size="88" name="descr2" />
...
$id2 = $_POST['id2'];
  ...
  $result = mysql_query("INSERT INTO slider (link,descr,descr2,id2)
 values('$dir','$descr','$descr2','$id2' )");
 echo "<br />";
if ($result){
echo ("inserted");
echo("<br>");
