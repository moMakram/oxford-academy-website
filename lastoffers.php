...
<div id="offtable">
<center>
  <table width="870" height="100" cellpadding="10" border="5">
  

    <tr style="background:#dc8f35; height:35px;">
	  <td style="width:160px; height:46px; font-size:16px; font-family:'Comic Sans MS'  , cursive; color:#000; text-align:center;"><br/>C.N</td>
      <td style="width:160px; height:46px; font-size:16px; font-family: 'Comic Sans MS' , cursive; color:#000; text-align:center;"><br/>price</td>
      <td style="width:160px; height:46px; font-size:16px; font-family: 'Comic Sans MS' , cursive; color:#000; text-align:center;"><br/>Description</td>
	 
	   <td style="width:160px; height:46px; font-size:16px; font-family: 'Comic Sans MS' , cursive; color:#000; text-align:center;"><br/>Reservation</td>
...
?>
	...
	<td style="width:90px; background-color:#b11d4a; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"><br/><?php echo $row['course'];  ?></td>
	<td style="width:90px; background-color:#b11d4a; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"><br/><?php echo $row['price'];  ?></td>
	<td style="width:90px; background-color:#b11d4a; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"><br/> <?php echo $row['descr'];  ?></td>
	
	<td style="width:90px; background-color:#b11d4a; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"><br/><?php echo"<a href='add_reserve.php?idoff="; echo $row['id']; echo"&idstu="; echo $id;  echo"'><font color='#FFF' > Reservation </font></a>"; ?> </td>
