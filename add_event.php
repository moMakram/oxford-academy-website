...
<font size="7px"><center>  اضافة الاحداث </center> </font>
<br><br>
...
$descr2 = $_POST['descr2'];
  ...
  $result = mysql_query("INSERT INTO event (title,title2,descr,descr2,id2)
 values('$title','$title2','$descr','$descr2','$id2' )");
 echo "<br /><br/><br/>";
if ($result){
echo ("inserted");
echo("<br/><br/><br/>");
