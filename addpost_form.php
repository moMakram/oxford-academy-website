...
<title>اضافه منشور للمدرس</title>
...
?>
	...
	<td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php  echo $row['name']; ?></td>
	  ...
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="add_post.php?id= '); echo $row['id']; ?>"> <font color="white"> update </font></a> </td>
    </tr> 
	<?php
