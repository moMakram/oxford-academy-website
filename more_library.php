...
<div id="more_milk">
<div id="namex2"><font color="#FFFFFF" > <center><font color="000000">'); echo $name; echo(' </font> </center><font></div>
...
<table width="770" height="129" border="0" style="position:absolute; margin-left:63px; margin-top:38px;">
 ...
 <tr>
 <td>
    <a href ="information.php?idpro='); echo $row['id']; echo('&id='); echo $id; echo('"><img src="'.$row['pic'].'" width="100px" height="100px" style=" margin-top:36px; border-radius:7px; border:inset; "  /></a>
	</td>
	</tr>
	<tr>
	<td align="center">
