...
<font size="7px"><center>  اضافه موضوع لمحاضر </center> </font>
<br><br>
...
<body role="application">
	...
	<div>
		...
		<font size="5"> ادخل الموضوع هنا </font>
		<div>
...
<center>
<font size="5px">  ملف الموضوع ان وجد  </font>
...
<input name="ordere" type="text" style=" height:25px; border-radius:4px; margin-left:10px; margin-top:0px;" />
...
$ordere = $_POST['ordere'];
  ...
  $result = mysql_query("INSERT INTO posts (down,post,id2,ordere)
 values('$imname','$post','$id','$ordere' )");
 echo "<br />";
if ($result){
echo ("inserted");
echo("<br>");
