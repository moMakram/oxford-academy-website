...
<title>التعديل على اجابات الطلبة</title>
...
$section = $_POST['section'];
	...
	$result = mysql_query("select * from answers where course='$course' and section='$section' and teacher='$name' order by id ");
...
<td style="width:30px; background-color:#03C;  height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#00000; text-align:center;"> <?php echo('<a href="'.$row['link'].'" >'.' ');
	  ...
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="delete2.php?id3= '); echo $row['id']; echo('&id='); echo $id;   echo('&table=answers'); echo('&form=updateans_form'); ?>"> <font color="white"> delete </font></a> </td>
    </tr> 
	<?php
