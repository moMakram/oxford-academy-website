...
$result = mysql_query("select * from marque where id ='$id3'");
...
$results = mysql_query("select * from prev where id='$id' ");
$rowss = mysql_fetch_array($results);
if($rowss['updatenews']=='1'){
?>
...
<font size="8" > التعديل على الخبر </font>
   <br/><br/><br/><br/>
	...
	<font size="5" > الخبر بالعربيه </font> <input type="descr" size="120" name="descr" value="<?php echo $rows['descr']; ?>" /><br/><br/>
    <font size="5" > الخبر بالانجليزيه </font><input type="descr2" size="120" name="descr2" value="<?php echo $rows['descr2']; ?>" /><br/><br/>
...
<input name="submit" id="submit4" type="submit" value="حفظ التعديلات" />
  ...
  <?php
	...
	$result2 = mysql_query(" update marque set  descr='$_POST[descr]',id2='$_POST[id2]',descr2='$_POST[descr2]' where id='$_POST[id]' " );
...
echo " <font size='3px' >اذا لم يتم نقلك تلقائيا  </font> <a href='updatenews_form.php?id="; echo $id; echo"'><font size='4px'> اضغط هنا </font> </a> </font>"; 
echo "<meta http-equiv=\"refresh\" content=\"1;URL=updatenews_form.php?id="; echo $id; echo"\">";
