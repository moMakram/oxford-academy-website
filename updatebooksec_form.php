...
<title>التحكم فى اقسام الكتب</title>
...
$ma = mysql_query("select * from prev where id='$id' ");
$mak = mysql_fetch_array($ma);
if($mak['updatebooksec']=='1'){
?>
...
?>
    ...
    <tr style="text-align:center;">
      ...
      <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="update2.php?id3= '); echo $row['id']; echo('&id=');echo $id; ?>"> <font color="white"> update </font></a> </td>
	  <td style="width:50px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;"> <?php echo (' <a href="delete.php?id3= '); echo $row['id']; echo('&id=');echo $id; echo('&table=product'); echo('&form=updatebooksec_form'); ?>"> <font color="white"> delete </font></a> </td>
    </tr> 
	<?php
