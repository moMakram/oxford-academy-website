...
<center>
  ...
  <table width="680" height="100" border="0">
	...
	<?php
		...
		$result = mysql_query("select * from prev where id='$id' and type='teacher'");
	...
	<tr style="background:#999; height:35px;">
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">التعديل على اسئله الطلبه </td>
      
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">
	 
	  
	  <select name="updatequestion" style="width:100px; height:30px;">

     <?php
	 if($row['updatequestion']=='0'){
     echo('
     <option>  0 </option>
	 <option> 1 </option>
     ');
	...
	<tr style="background:#999; height:35px;">
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">اضافه المهام </td>
      
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">
	 
	  
	  <select name="addtask" style="width:100px; height:30px;">
	...
	<tr style="background:#999; height:35px;">
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">التعديل على المهام </td>
      
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">
	 
	  
	  <select name="updatetask" style="width:100px; height:30px;">
     ...
     ?>
		...
		<tr style="background:#999; height:35px;">
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">التعديل على اجابات الطلبه </td>
      
	  <td style="width:90px; background-color:#03C; height:44px; font-size:16px; font-family:'Comic Sans MS', cursive; color:#FFF; text-align:center;">
	 
	  
	  <select name="updateans" style="width:100px; height:30px;">
...
updatequestion='$updatequestion',addtask='$addtask',updatetask='$updatetask',updateans='$updateans'
 where id='$id'  " ) ;
...
echo " <font size='3px' >اذا لم يتم نقلك تلقائيا  </font> <a href='updateuser2_form.php'><font size='4px'> اضغط هنا </font> </a> </font>"; 
echo "<meta http-equiv=\"refresh\" content=\"2;URL=updateuser2_form.php\">";
echo('</center>');
}
else
{
