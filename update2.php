...
$result = mysql_query("select * from product where id ='$id3'");
...
echo " <font size='3px' >اذا لم يتم نقلك تلقائيا  </font> <a href='updatebooksec_form.php?id="; echo $id; echo"'><font size='4px'> اضغط هنا </font> </a> </font>"; 
echo "<meta http-equiv=\"refresh\" content=\"1;URL=updatebooksec_form.php?id="; echo $id; echo"\">";
