...
<div id="upmak">
<font color="#FFFFFF"> please upload the answer from here </font>
</div>

<br/><br/><br/><br/><br/><br/><br/>
<form method="POST" enctype="multipart/form-data">

<input name="file" type="file" style="background-color:#930; height:30px; border-radius:4px; margin-left:660px; margin-top:70px;" />

<br><br><br><br/><br/><br/>
<center>
<input type="submit" name="submit" value="upload " style=" width:85px; height:40px; border-radius:10px; font-family:"Comic Sans MS", cursive; color:#000000; "/>
...
if(isset($_POST['submit'])){
    ...
    else
    {
        ...
        if (file_exists("answers/" . $_FILES["file"]["name"]))
        {
            echo "A file with the name " . $_FILES["file"]["name"] . " already exists. ";
        }
        else
        {
            move_uploaded_file($_FILES["file"]["tmp_name"], "answers/" . $_FILES["file"]["name"]);
            echo "The file was stored in: " . "answers/" . $_FILES["file"]["name"];
        }
    }
	   $imname =  $_FILES["file"]["name"];
	   $dir = "answers/".$_FILES['file']['name'];
  ...
  $result = mysql_query("INSERT INTO answers (link,name,course,section,teacher,id2)
 values('$dir','$name','$course','$section','$teacher','$id' )");
 echo "<br />";
if ($result){
echo ("inserted");
echo("<br>");
