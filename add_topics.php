...
<font size="7px"><center>  اضافه مواضيع الرئيسية </center> </font>
<br><br>

<center>
<font size="5px">  صوره الموضوع  </font>
...
<center>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font size="5px"> عنوان الموضوع بالعربية </font>
...
<center>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font size="5px"> عنوان الموضوع بالانجليزية </font>


<input type="text" name="title2" size="50" />
</center>
...
$descr2 = $_POST['descr2'];
  ...
  $result = mysql_query("INSERT INTO topics (link,title,title2,descr,descr2,id2)
 values('$dir','$title','$title2','$descr','$descr2','$id2' )");
 echo "<br />";
if ($result){
echo ("inserted");
echo("<br>");
